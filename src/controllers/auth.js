...
exports.resetPassword = asyncHandler(async (req, res, next) => {
    crypto.randomBytes(32, async (err, buffer) => {
        ...
        try {
            ...
            sendMail(email, `<p>You requested for password change</p><h5>click on this <a href="https://localhost:3000/api/auth/reset-password/${token}"> link </a> to reset your password</h5>`).then(() => {
